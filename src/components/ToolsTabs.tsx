            ...
            {tools.map((tool) => {
              ...
              return (
                <TabsTrigger 
                  key={tool.id} 
                  value={tool.id}
                  className="flex flex-col p-4 space-y-2 data-[state=active]:bg-gradient-primary data-[state=active]:text-white transition-all duration-300"
                >
              ...
              <TabsContent key={tool.id} value={tool.id} className="mt-8">
                <Card className="bg-card/50 backdrop-blur-sm border-border/50 shadow-card">
                  ...
                  <CardContent className="space-y-8">
                    {/* Demo section */}
                    <div className="bg-gradient-secondary/10 rounded-xl p-8 text-center">
